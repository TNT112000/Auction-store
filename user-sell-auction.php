...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="grid wide">
                <div class="content-product" style="overflow-x:auto;">
                    <table class="table-users" style="width: 100%;">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM users u,list_book l,moth m WHERE  u.user_name=l.user_top AND m.thang_id=l.thang_id AND l.book_own='$_SESSION[loginOK]' ";
